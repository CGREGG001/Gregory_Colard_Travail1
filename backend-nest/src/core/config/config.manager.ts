...
import { ConfigKey, configMinimalKeys } from "./enums/config-key.enum";
...
class ConfigManager {
    ...
    /**
     * Generates the TypeORM configuration options based on environment variables.
     * @returns {TypeOrmModuleOptions} The configuration object for TypeORM.
     */
    ...
    // Retrieves a configuration value or throws an error if missing
